...
namespace LNF.Models.Scheduler
{
    public interface ISchedulerService
    {
        ...
        IEnumerable<ReservationItemWithInvitees> GetReservationsWithInvitees(DateTime sd, DateTime ed, int clientId = 0, int resourceId = 0, int activityId = 0, bool? started = null, bool? active = null);
