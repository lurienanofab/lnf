...
namespace LNF.Impl.Data
{
    public class DryBoxManager : ManagerBase, IDryBoxManager
    {
        ...
        public bool? IsAccountActive(int dryBoxId)
        {
            ...
            var ca = Session.Single<ClientAccountInfo>(dba.ClientAccountID);
        ...
        {
            var db = Session.Single<DryBox>(dryBoxId);
            var ca = Session.Single<ClientAccount>(clientAccountId);
        ...
        {
            var dba = Session.Single<DryBoxAssignment>(dryBoxAssignmentId);
        ...
        {
            var dba = Session.Single<DryBoxAssignment>(dryBoxAssignmentId);
            var modifiedBy = Session.Single<Client>(modifiedByClientId);
        ...
        {
            var entity = Session.Single<DryBoxAssignment>(dba.DryBoxAssignmentID);
            var ca = Session.Single<ClientAccount>(clientAccountId);
            var modifiedBy = Session.Single<Client>(modifiedByClientId);
        ...
        {
            var dryBox = Session.Single<DryBox>(model.DryBoxID);
