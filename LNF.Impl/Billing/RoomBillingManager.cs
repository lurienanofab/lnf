...
{
    public class RoomBillingManager : ManagerBase, IRoomBillingManager
    {
        public RoomBillingManager(IProvider provider) : base(provider) { }
        ...
        private IQueryable<Repository.Billing.IRoomBilling> GetRoomBillingQuery(bool temp)
        {
            if (temp)
