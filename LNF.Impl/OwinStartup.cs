        ...
        public virtual void ConfigureAuth(IAppBuilder app)
        {
            if (UseCookieAuthentication)
            {
                ...
                app.UseCookieAuthentication(new CookieAuthenticationOptions
                {
                    ...
                    LoginPath = new PathString(Providers.Context.LoginUrl),
                    Provider = new CookieAuthenticationProvider()
                    {
                        OnApplyRedirect = context =>
                        {
                            context.RedirectUri = Providers.Context.LoginUrl + new QueryString(context.Options.ReturnUrlParameter, context.Request.Uri.PathAndQuery);
