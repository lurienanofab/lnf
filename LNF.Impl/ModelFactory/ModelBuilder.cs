    ...
    public static class ModelBuilder
    {
        ...
        public static class Scheduler
        {
            ...
            public static ResourceItem CreateResourceModel(Resource source)
            {
                ...
                result.ReservFence = source.ReservFence;
                result.MinReservTime = source.MinReservTime;
                result.MaxReservTime = source.MaxReservTime;
                result.MaxAlloc = source.MaxAlloc;
                result.Offset = source.Offset;
                result.GracePeriod = source.GracePeriod;
                result.ResourceAutoEnd = source.AutoEnd;
                result.MinCancelTime = source.MinCancelTime;
                result.UnloadTime = source.UnloadTime.GetValueOrDefault(0);
