...
{
    public class ServiceLogService : LogProviderBase
    {
    ...
    public class Log : LogBase
    {
        protected override void OnWrite(LogMessage message)
        {
            ...
            var serviceLog = new ServiceLog()
            {
                ...
                ServiceName = ServiceProvider.Current.Log.Name,
        ...
        protected override int OnPurge(DateTime cutoff)
        {
            ...
            var count = DA.Current.SqlQuery(sql).SetParameters(new { cutoff }).Update();
            return count;
        }
    }
}
